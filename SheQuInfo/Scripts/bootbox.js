...
var bootbox = window.bootbox || (function (document, $) {
    ...
    */
    ...
    that.dialog = function (str, handlers, options) {
        ...
        parts.push("</div>"); //<!-- /.modal-content -->
        parts.push("</div>"); //<!-- /.modal-dialog -->
        parts.push("</div>");
        ...
        window.bootboxIndex = window.bootboxIndex + 2;
        div.css("z-index", window.bootboxIndex);
        $(".modal-body", div).css('max-height', document.documentElement.clientHeight * 0.7); //默认弹窗高度
        $('.modal-backdrop:last').css("z-index", window.bootboxIndex - 1);
